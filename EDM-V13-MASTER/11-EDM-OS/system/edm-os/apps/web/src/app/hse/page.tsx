  ...
  return (
    <Shell>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
        <Card className="p-4 bg-emerald text-white border-emerald"><div className="text-[11px] uppercase tracking-wider font-semibold text-sage">Lost-time incidents</div><div className="mt-1 text-2xl font-bold">{h.lostTime}</div></Card>
